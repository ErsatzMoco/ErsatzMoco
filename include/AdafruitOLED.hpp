...
#ifndef ADAFRUITOLED_H
#define ADAFRUITOLED_H
...
class AdafruitOLED : public Display
{
    public:
        AdafruitOLED();
        virtual ~AdafruitOLED();
        ...
        Adafruit_SSD1331 accessLowlevel();

    protected:
        Adafruit_SSD1331 hardware_;

    private:
};

#endif // ADAFRUITOLED_H
