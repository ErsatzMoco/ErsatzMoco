...
#define ADA_SCLK 24
#define ADA_MOSI 23
//#define ADA_CS   10   //display does not use SPI
#define ADA_RST  9
#define ADA_DC   6
...
#define OLED_RESET -1   // display reset pin, if applicable, else -1
#define I2C_ADR 0x3C    // Address for 128x32 is 0x3C
...
class MonoOLED : public Display
{
    public:
        ...
        Adafruit_SSD1306 accessLowlevel();

    protected:
        Adafruit_SSD1306 hardware_;
