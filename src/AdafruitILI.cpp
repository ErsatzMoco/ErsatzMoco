...
#include "../include/AdafruitILI.hpp"

/** @brief Wrapper for displays using the ILI 9341 driver chip. Connects to the corresponding library by Adafruit.
  *
  ...
  * Pins for talking to driver chip (SPI) must be set up in header file AdafruitILI.hpp!
  * @see Display
  */
AdafruitILI::AdafruitILI() : hardware_(Adafruit_ILI9341(ADA_CS, ADA_DC, ADA_RST))
{
    //ctor
}

AdafruitILI::~AdafruitILI()
{
    //dtor
}
...
/** @brief Access Adafruit library directly: Returns library object.
  *
  */
Adafruit_ILI9341 AdafruitILI::accessLowlevel()
{
    return hardware_;
}

bool AdafruitILI::isEnabled()
{
    return enabled_;
}
...
/** @brief Set basic pixel dimensions and standard rotation, define dedicated grid space and clear screen.
  *
  */
void AdafruitILI::initDisplay(Shapesize gs, int gminx, int gminy, int gmaxx, int gmaxy)
{
    elemList_ = {};
...
/** @brief Clear screen with dedicated color.
  *
  */
void AdafruitILI::cls(Color col)
{
...
/** @brief Add a high level display component to refresh list.
  ...
  * @see DisplayElement
  */
void AdafruitILI::addElement(DisplayElement* de)
{
    de->setDisplay(this);
...
/** @brief Remove a high level display component from refresh list.
  ...
  * @see DisplayElement
  */
void AdafruitILI::removeElement(DisplayElement* de)
{
    int ctr = 0;
...
/** @brief Retrieve component from refresh list by providing its number in the list.
  *
  */
DisplayElement* AdafruitILI::getElementByNum(int num)
{
...
/** @brief Draw empty rectangle providing pixel position, size and color.
  ...
  */
void AdafruitILI::drawRect(Position pixpos, Shapesize asize, Color col)
{
...
/** @brief Draw empty rectangle providing start and end pixel positions and color.
  ...
  * @see Position, Color
  */
void AdafruitILI::drawRect(Position startpos, Position endpos, Color col)
{
...
/** @brief Draw filled rectangle providing providing pixel position, size and color.
  ...
  * @see Position, Shapesize, Color
  */
void AdafruitILI::fillRect(Position pixpos, Shapesize asize, Color col)
{
...
/** @brief Draw filled rectangle providing start and end pixel positions and color.
  ...
  * @see Position, Color
  */
void AdafruitILI::fillRect(Position startpos, Position endpos, Color col)
{
    Shapesize asize((endpos.x - startpos.x + 1), (endpos.y - startpos.y + 1));
...
/** @brief Draw line providing start and end pixel positions and color.
  ...
  * @see Position, Color
  */
void AdafruitILI::drawLine(Position startpos, Position endpos, Color col)
{
...
/** @brief Draw text providing pixel position, c string, foreground and background color.
  ...
  * @see Position, Color
  */
void AdafruitILI::drawText(Position pixpos, char* atext, Color fg, Color bg)
{
...
/** @brief Draw text providing pixel position, c string and foreground color.
  ...
  * @see Position, Color
  */
void AdafruitILI::drawText(Position pixpos, char* atext, Color fg)
{
    hardware_.setCursor(pixpos.x, pixpos.y);
...
/** @brief Draw text providing pixel position, c string, size, foreground and background color.
  ...
  * @see Position, Color
  */
void AdafruitILI::drawText(Position pixpos, char* atext, int asize, Color fg, Color bg)
{
...
/** @brief Draw text providing pixel position, c string, size and foreground color.
  ...
  * @see Position, Color
  */
void AdafruitILI::drawText(Position pixpos, char* atext, int asize, Color fg)
{
    hardware_.setTextSize(asize);
...
/** @brief Draw text providing grid position, c string, foreground and background color.
  ...
  * @see Position, Color
  */
void AdafruitILI::drawGridText(Position gridpos, char* atext, Color fg, Color bg)
{
...
/** @brief Draw text providing grid position, c string, size, foreground and background color.
  ...
  * @see Position, Color
  */
void AdafruitILI::drawGridText(Position gridpos, char* atext, int asize, Color fg, Color bg)
{
    hardware_.setTextSize(asize);
...
/** @brief Get text box boundaries for a given string using the curretly set text size. This is just a convenience wrapper for the Adafruit GFX function with same name.
  ...
  */
void AdafruitILI::getTextBounds(char* str, int16_t x, int16_t y,
...
/** @brief Set font size for next text drawing. This is just a convenience wrapper for the Adafruit GFX function with same name.
  *
  */
void AdafruitILI::setFontSize(int fsize)
{
...
/** @brief Draw empty rectangle providing grid position, size and color.
  ...
  * @see Position, Shapesize, Color
  */
void AdafruitILI::drawGridRect(Position gridpos, Shapesize asize, Color col)
{
    Position pixpos = gridToPix(gridpos);
...
/** @brief Draw filled rectangle providing grid position, size and color.
  ...
  * @see Position, Shapesize, Color
  */
void AdafruitILI::fillGridRect(Position gridpos, Shapesize asize, Color col)
{
    Position pixpos = gridToPix(gridpos);
...
/** @brief Draw emphasized text providing grid position, c string, foreground and background color.
  ...
  * @see Position, Shapesize, Color
  */
void AdafruitILI::drawGridHeadline(Position gridpos, char* atext, Color fg, Color bg)
{
    Position pixpos = gridToPix(gridpos);
...
/** @brief Draw bitmap loaded from SD card providing a filename and grid position. Returns bitmap size.
  ...
  */
Shapesize AdafruitILI::bmpGridDraw(char* filename, Position gridpos)
{
    Position pixpos = gridToPix(gridpos);
    Shapesize mysize;
...
/** @brief Retrieve size of bitmap on SD card providing a filename.
  ...
  * @see Shapesize
  */
Shapesize AdafruitILI::readBmpSize(char* filename)
{
    File     bmpFile;
...
/** @brief Draw bitmap loaded from SD card providing a filename and pixel position. Returns bitmap size.
  ...
  * @see Position, Shapesize
  */
Shapesize AdafruitILI::bmpDraw(char* filename, int16_t x, int16_t y)
{
    Shapesize bmpsize = Shapesize(0, 0);
    File     bmpFile;
    int      bmpWidth = 0;
