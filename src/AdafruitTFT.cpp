...
#include "../include/AdafruitTFT.hpp"

/** @brief Wrapper for displays using the ST 7735 driver chip. Connects to the corresponding library by Adafruit.
  *
  ...
  * Pins for talking to driver chip (SPI) must be set up in header file AdafruitTFT.hpp!
  * @see Display
  */
AdafruitTFT::AdafruitTFT() : hardware_(Adafruit_ST7735(ADA_CS, ADA_DC, ADA_RST))
{
    //ctor
}
...
/** @brief Access Adafruit library directly: Returns library object.
  *
  */
Adafruit_ST7735 AdafruitTFT::accessLowlevel()
{
    return hardware_;
}

bool AdafruitTFT::isEnabled()
{
    return enabled_;
}
...
void AdafruitTFT::initDisplay()
{
    ...
    pinMode(ADA_CS, OUTPUT);
    digitalWrite(ADA_CS, HIGH);
    pinMode(ADA_SDCS, OUTPUT);
    digitalWrite(ADA_SDCS, HIGH);

    hardware_.initR(INITR_BLACKTAB);
    hardware_.setRotation(3);
...
/** @brief Set basic pixel dimensions and standard rotation, define dedicated grid space and clear screen.
  *
  */
void AdafruitTFT::initDisplay(Shapesize gs, int gminx, int gminy, int gmaxx, int gmaxy)
{
    elemList_ = {};
...
/** @brief Clear screen with dedicated color.
  *
  */
void AdafruitTFT::cls(Color col)
{
...
/** @brief Add a high level display component to refresh list.
  ...
  * @see DisplayElement
  */
void AdafruitTFT::addElement(DisplayElement* de)
{
    de->setDisplay(this);
...
/** @brief Remove a high level display component from refresh list.
  ...
  * @see DisplayElement
  */
void AdafruitTFT::removeElement(DisplayElement* de)
{
    int ctr = 0;
...
/** @brief Retrieve component from refresh list by providing its number in the list.
  *
  */
DisplayElement* AdafruitTFT::getElementByNum(int num)
{
...
/** @brief Draw empty rectangle providing pixel position, size and color.
  ...
  */
void AdafruitTFT::drawRect(Position pixpos, Shapesize asize, Color col)
{
...
/** @brief Draw empty rectangle providing start and end pixel positions and color.
  ...
  * @see Position, Color
  */
void AdafruitTFT::drawRect(Position startpos, Position endpos, Color col)
{
...
/** @brief Draw filled rectangle providing providing pixel position, size and color.
  ...
  * @see Position, Shapesize, Color
  */
void AdafruitTFT::fillRect(Position pixpos, Shapesize asize, Color col)
{
...
/** @brief Draw filled rectangle providing start and end pixel positions and color.
  ...
  * @see Position, Color
  */
void AdafruitTFT::fillRect(Position startpos, Position endpos, Color col)
{
    Shapesize asize((endpos.x - startpos.x + 1), (endpos.y - startpos.y + 1));
...
/** @brief Draw line providing start and end pixel positions and color.
  ...
  * @see Position, Color
  */
void AdafruitTFT::drawLine(Position startpos, Position endpos, Color col)
{
...
/** @brief Draw text providing pixel position, c string, foreground and background color.
  ...
  * @see Position, Color
  */
void AdafruitTFT::drawText(Position pixpos, char* atext, Color fg, Color bg)
{
...
/** @brief Draw text providing pixel position, c string and foreground color.
  ...
  * @see Position, Color
  */
void AdafruitTFT::drawText(Position pixpos, char* atext, Color fg)
{
    hardware_.setCursor(pixpos.x, pixpos.y);
...
/** @brief Draw text providing pixel position, c string, size, foreground and background color.
  ...
  * @see Position, Color
  */
void AdafruitTFT::drawText(Position pixpos, char* atext, int asize, Color fg, Color bg)
{
...
/** @brief Draw text providing pixel position, c string, size and foreground color.
  ...
  * @see Position, Color
  */
void AdafruitTFT::drawText(Position pixpos, char* atext, int asize, Color fg)
{
    hardware_.setTextSize(asize);
...
/** @brief Draw text providing grid position, c string, foreground and background color.
  ...
  * @see Position, Color
  */
void AdafruitTFT::drawGridText(Position gridpos, char* atext, Color fg, Color bg)
{
...
/** @brief Draw text providing grid position, c string, size, foreground and background color.
  ...
  * @see Position, Color
  */
void AdafruitTFT::drawGridText(Position gridpos, char* atext, int asize, Color fg, Color bg)
{
    hardware_.setTextSize(asize);
...
/** @brief Get text box boundaries for a given string using the curretly set text size. This is just a convenience wrapper for the Adafruit GFX function with same name.
  ...
  */
void AdafruitTFT::getTextBounds(char* str, int16_t x, int16_t y,
...
/** @brief Set font size for next text drawing. This is just a convenience wrapper for the Adafruit GFX function with same name.
  *
  */
void AdafruitTFT::setFontSize(int fsize)
{
...
/** @brief Draw empty rectangle providing grid position, size and color.
  ...
  * @see Position, Shapesize, Color
  */
void AdafruitTFT::drawGridRect(Position gridpos, Shapesize asize, Color col)
{
    Position pixpos = gridToPix(gridpos);
...
/** @brief Draw filled rectangle providing grid position, size and color.
  ...
  * @see Position, Shapesize, Color
  */
void AdafruitTFT::fillGridRect(Position gridpos, Shapesize asize, Color col)
{
    Position pixpos = gridToPix(gridpos);
...
/** @brief Draw emphasized text providing grid position, c string, foreground and background color.
  ...
  * @see Position, Shapesize, Color
  */
void AdafruitTFT::drawGridHeadline(Position gridpos, char* atext, Color fg, Color bg)
{
    Position pixpos = gridToPix(gridpos);
...
/** @brief Draw bitmap loaded from SD card providing a filename and grid position. Returns bitmap size.
  ...
  */
Shapesize AdafruitTFT::bmpGridDraw(char* filename, Position gridpos)
{
    Position pixpos = gridToPix(gridpos);
    Shapesize mysize;
...
/** @brief Retrieve size of bitmap on SD card providing a filename.
  ...
  * @see Shapesize
  */
Shapesize AdafruitTFT::readBmpSize(char* filename)
{
    File     bmpFile;
...
/** @brief Draw bitmap loaded from SD card providing a filename and pixel position. Returns bitmap size.
  ...
  * @see Position, Shapesize
  */
Shapesize AdafruitTFT::bmpDraw(char* filename, int16_t x, int16_t y)
{
    Shapesize bmpsize = Shapesize(0, 0);
    File     bmpFile;
    int      bmpWidth = 0;
                ...
                if((x2 >= 0) && (y2 >= 0)) // On screen?
                {
                    ...
                    for (row=0; row<h; row++) // For each scanline...
                    {
                        ...
                        for (col=0; col<w; col++) // For each pixel...
                        {
                            ...
                            g = sdbuffer[buffidx++];
                            r = sdbuffer[buffidx++];
                            hardware_.pushColor(hardware_.color565(r,g,b));
